...
public class PacketReaderImpl implements PacketReader {
    ...
    private Channel getChannel(ServerGamePacketListenerImpl packetListener){
        try{
            System.out.println(ServerGamePacketListenerImpl.class.getName());
            //packetListener.player.connection.connection.channel;
            Field field = ServerGamePacketListenerImpl.class.getDeclaredField("h");
